...
\begin{document}
	...
	\begin{figure}
		\centering
		\subcaptionbox{Early stage}{\includegraphics[width=0.4\textwidth]{sobel_map_1}}
		\subcaptionbox{Intermediate stage}{\includegraphics[width=0.4\textwidth]{sobel_map_2}}
		\subcaptionbox{Late stage}{\includegraphics[width=0.4\textwidth]{sobel_map_3}}
